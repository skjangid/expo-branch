...
class Branch {
  ...
  isTrackingDisabled = RNBranch && RNBranch.isTrackingDisabled
  ...
  getFirstReferringParams = RNBranch && RNBranch.getFirstReferringParams
  ...
  logout = RNBranch && RNBranch.logout
  userCompletedAction = (event, state = {}) => RNBranch.userCompletedAction(event, state)
  getShortUrl = RNBranch && RNBranch.getShortUrl
  ...
  getCreditHistory = RNBranch && RNBranch.getCreditHistory
